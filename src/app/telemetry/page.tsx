...
function SimulationInput({ label, id, type = "text", value, onChange, placeholder, step, required = false, disabled = false }: SimulationInputProps) {
  return (
    <div>
...
export default function TelemetryPage() {
  ...
  return (
    // Main grid layout: 3 columns for controls, 2 for previews on large screens
    <div className="grid grid-cols-1 gap-6 lg:grid-cols-5">
      ...
      <div className="rounded-lg bg-gray-800 p-6 shadow-lg lg:col-span-3">
        ...
        <section className="mb-8">
          <h2 className="mb-4 text-lg font-medium text-white border-b border-gray-700 pb-2">GPS Simulation</h2>
        ...
        {/* Sensor Data Group */}
        <section className="mb-8">
          <h2 className="mb-4 text-lg font-medium text-white border-b border-gray-700 pb-2">Sensor Data</h2>
          <div className="grid grid-cols-1 gap-x-6 gap-y-4 md:grid-cols-2">
            <SimulationInput 
              label="Temperature (°C)" 
              id="temperature" 
        ...
        <section className="mb-8">
          <h2 className="mb-4 text-lg font-medium text-white border-b border-gray-700 pb-2">Battery Status</h2>
          <div className="grid grid-cols-1 gap-x-6 gap-y-4 md:grid-cols-2">
            <SimulationInput 
              label="Voltage (V)" 
              id="voltage" 
      ...
      <div className="flex flex-col gap-6 lg:col-span-2">
        ...
        <div className="rounded-lg bg-gray-800 p-6 shadow-lg">
          ...
          <div className="space-y-4 rounded bg-gray-700 p-4 text-sm text-gray-200">
            ...
            <div className="flex justify-between">
              <span>CO Level:</span>
              <span>{telemetryData.coLevel.toFixed(2)} PPM</span>
            </div>
            <div className="flex justify-between">
              <span>NO₂ Level:</span>
              <span>{telemetryData.no2Level.toFixed(2)} PPM</span>
            </div>
            <div className="flex justify-between">
              <span>SO₂ Level:</span>
              <span>{telemetryData.so2Level.toFixed(2)} PPM</span>
            </div>
            <div className="flex justify-between">
              <span>Battery:</span>
              <span>{telemetryData.batteryPercentage.toFixed(1)}%</span>
            </div>
            <div className="flex justify-between">
              <span>Status:</span>
